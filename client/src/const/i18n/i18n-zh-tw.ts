export const i18nZhTw = {
  common: {
    ...
    auto_find_cover_image: '自動尋找封面圖',
    finding_cover_image: '尋找封面圖中...',
    fail_to_find_cover_image: '未能成功為本書找到封面圖',
    connected: '已連線',
    not_connected: '未連線',
    expired: '已過期',
    no_matched: '沒有符合的項目',
  ...
  page: {
    ...
    bookmarks: {
      ...
      create_tag: '建立 "{0}"',
      no_tags_under_book: '書本中未包含有標籤的劃線',
      no_tags_under_book_collection: '收藏中未包含有標籤的劃線',
      collection: '收藏',
